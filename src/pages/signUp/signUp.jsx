    ...
    <main className="p-5 py-20 w-full lg:max-w-xl m-auto">
      <form className="flex flex-col items-start gap-5">
        ...
        <div className="flex flex-col w-full gap-5">
          ...
          <button className="px-5 py-3 flex items-center justify-center border-2 gap-3 font-medium rounded-sm">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
            ...
            >
              <g clip-path="url(#clip0_29420_3148)">
                <path
          ...
          <p className="text-center">Already have account? <span className="underline text-gray-500">Log in</span></p>
        </div>
      </form>
    </main>
  );
